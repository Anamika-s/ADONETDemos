...
namespace AdoNetDemos
    {
        ...
        static void InsertRecord()
        {
            using (SqlConnection connection = GetConnnection())
            {
                ...
                using (SqlCommand command = new SqlCommand("Insert into Employee (id, name , address, salary) values(@id, @name,@address,@salary)", connection))
                {
        ...
        static void UpdateRecord()
        {
            using (SqlConnection connection = GetConnnection())
            {
                ...
                int salary = int.Parse(Console.ReadLine());
                using (SqlCommand command = new SqlCommand("Update Employee" +
                    "set address =@adress, salary = @salary where is=@id", connection))
                {
            ...
            static void DeleteRecord()
            {
                using (SqlConnection connection = GetConnnection())
                {
                    ...
                    using (SqlCommand command = new SqlCommand("Delete Employee" +
            ...
            static void GetRecords()
            {
                using (SqlConnection connection = GetConnnection())
                {
                    using (SqlCommand command = new SqlCommand("Select * from Employee",
                    connection))
                    {
